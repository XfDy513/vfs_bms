<?php /*a:3:{s:71:"D:\worker\phpstudy\WWW\wfs_louyu\application\admin\view\news\index.html";i:1568778576;s:72:"D:\worker\phpstudy\WWW\wfs_louyu\application\admin\view\layout\main.html";i:1568194890;s:71:"D:\worker\phpstudy\WWW\wfs_louyu\application\admin\view\inc\header.html";i:1568194890;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="layui-form">
        <div class="layui-inline">
            <div class="layui-input-inline">
                <input name="title" type="text" class="layui-input" placeholder="请输入搜索新闻标题"/>
            </div>
            <div class="layui-input-inline">
...
<script>
    layui.use(['form', 'table', 'jquery', 'layer', 'upload'], function () {
        ...
        tablelistobj.tool_obj = {
            lists: {href: "<?php echo url('admin/news/lists'); ?>", title: '列表'},
            add: {href: "<?php echo url('admin/news/add'); ?>", title: '添加'},
            edit: {href: "<?php echo url('admin/news/edit'); ?>", title: '编辑'},
            del: {href: "<?php echo url('admin/news/del'); ?>", title: '删除'},
        };
        tablelistobj.cols = [[
