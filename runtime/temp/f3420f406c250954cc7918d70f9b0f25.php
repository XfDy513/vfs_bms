<?php /*a:3:{s:76:"D:\worker\phpstudy\WWW\wfs_louyu\application\admin\view\news_cate\index.html";i:1569202725;s:72:"D:\worker\phpstudy\WWW\wfs_louyu\application\admin\view\layout\main.html";i:1568194890;s:71:"D:\worker\phpstudy\WWW\wfs_louyu\application\admin\view\inc\header.html";i:1568194890;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    layui.use(['form', 'table', 'jquery', 'layer', 'upload'], function () {
        ...
        tablelistobj.tool_obj = {
            lists: {href: "<?php echo url('admin/news_cate/lists'); ?>", title: '列表'},
            add: {href: "<?php echo url('admin/news_cate/add'); ?>", title: '添加'},
            edit: {href: "<?php echo url('admin/news_cate/edit'); ?>", title: '编辑'},
            del: {href: "<?php echo url('admin/news_cate/del'); ?>", title: '删除'},
        };
        tablelistobj.cols = [[
